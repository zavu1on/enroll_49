# Generated by Django 4.1.1 on 2022-10-07 17:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('verification', 'В процессе верификации заявки'), ('processed', 'В процессе обработки заявки'), ('successed', 'Вы приняты'), ('rejected', 'Вы не приняты')], default='verification', help_text='Заполняется администрацией', max_length=100, verbose_name='Статус заявки')),
                ('message', models.TextField(default='', verbose_name='Сообщение для учеников')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='admission.profileclass', verbose_name='Профильные классы'),
        ),
        migrations.AddField(
            model_name='enrollapplication',
