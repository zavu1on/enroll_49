    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=100, unique=True, verbose_name='Контактный телефон')),
                ('email', models.CharField(blank=True, max_length=300, unique=True, verbose_name='Контактный адрес электронной почты')),
                ...
                ('mother_fio', models.CharField(max_length=300, verbose_name='ФИО матери')),
                ('mother_phone', models.CharField(max_length=100, verbose_name='Контактный телефон матери')),
                ('mother_address', models.CharField(max_length=500, verbose_name='Адрес места жительства матери')),
